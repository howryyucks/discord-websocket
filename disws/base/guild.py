...
class DiscordGuild(BaseRequest):
    ...
    async def get_guild(
        ...
        :param from_cache: Returns :class:`Guild` from a :class:`GuildCache` object.
            Defaults to True.
                ...
                guild = (
                    {
                        ...
                        "communication_disabled_until": json_r.get(
                            "communication_disabled_until", None
                        ),
                    }
                    if not without_guild
                    else None
                )
